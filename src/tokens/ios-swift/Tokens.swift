...
public class Tokens {
    ...
    public static let colorPrimaryDark = UIColor(red: 0.341, green: 0.255, blue: 0.569, alpha:1)
    public static let colorPrimaryLight = UIColor(red: 0.584, green: 0.498, blue: 0.808, alpha:1)
    public static let colorPrimaryMain = UIColor(red: 0.451, green: 0.337, blue: 0.749, alpha:1)
